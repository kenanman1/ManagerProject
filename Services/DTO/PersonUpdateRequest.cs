...
public class PersonUpdateRequest
{
    ...
    public static PersonUpdateRequest ToPersonUpdate(PersonResponce responce)
    {
        return new PersonUpdateRequest() { Id = responce.ID, Name = responce.Name, Surname = responce.Surname, Email = responce.Email, BirthDate = responce.BirthDate, Address = responce.Address, CountryId = responce.CountryId };
    }
}
